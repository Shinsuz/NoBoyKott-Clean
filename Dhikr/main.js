function counter() {
  ...
  const dhikrs = [
    ...
    { id: 7, name: "100x Lā ʾilāha ʾillā -llāh, waḥdahu lā šarīka lahu, lahul-mulku wa lahu-l-ḥamdu, wa huwa `alā kulli šay'in qadī", text: "لَا إِلَٰهَ إِلَّا ٱللَّٰهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ ٱلْمُلْكُ وَلَهُ ٱلْحَمْدُ، وَهُوَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ ", count: 0 , source: "Sahih al-Buhari 3293, Sahih Muslim 2691", reward: "Zehn Sklavenfreilassungen, 100 gute Taten, 100 Sünden getilgt, Schutz vor dem Shaytan den ganzen Tag"},
