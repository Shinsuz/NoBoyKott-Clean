function counter() {
  ...
  const dhikrs = [
    ...
    { id: 7, name: "100x La ilaha illallah wahdahu la sharika lahu lahul mulku wa ala kulli shayin qadeer", text: "لَا إِلَٰهَ إِلَّا ٱللَّٰهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ ٱلْمُلْكُ وَلَهُ ٱلْحَمْدُ وَهُوَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ ", count: 0 , source: "Sahih al-Buhari 3293, Sahih Muslim 2691", reward: "Zehn Sklavenfreilassungen, 100 gute Taten, 100 Sünden getilgt, ein Schutz vor dem Shaytan den ganzen Tag"},
    { id: 8, name: "3x / 100x Ikhlas", text: "إِخْلَاص", count: 0, source: "Sahih al-Bukhari 5013, Tirmidhi 2898", reward: "1x Ikhlas gleicht 1/3 des Qurans" },
